...
#ifndef BxStackingMuon_h
#define BxStackingMuon_h 1
...
class BxStackingMuon : public BxVStackingAction
{
  public:
      BxStackingMuon();
      virtual ~BxStackingMuon();
...
//---------------------------------------------------------------
      ...
      //void SetStackManager(G4StackManager* man) { stackManager = man ; }
      //virtual G4StackManager* GetStackManager() { return stackManager ; }

    
    void   SetSorting(const G4Track* aTrack);
    G4bool GetSorting(const G4Track* aTrack);
